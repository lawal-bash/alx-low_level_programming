...
/**
 * check97beforecp - checking for correct number
 * @argc: number of arguments
 * Return: void
 */
void check97beforecp(int argc)
{
if (argc != 3)
{
...
/**
 * check98 - checks that file exists and readable
 * @check: checks if 1 or 0
 * @file: file from name
 * @fd_from: file descriptor of file from or -1
...
/**
 * check99 - checks that file_to was created and can be written into
 * @check: checks if 1 or 0
 * @file: file to name
 * @fd_from: file descriptor of file from or -1
